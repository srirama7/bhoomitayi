...
function CommercialContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-200 via-amber-100 to-orange-200 dark:from-amber-800 dark:via-orange-900 dark:to-amber-700 relative overflow-hidden">
      ...
      <div className="relative overflow-hidden shadow-2xl min-h-[280px] sm:min-h-[340px] flex items-center justify-center">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-amber-950/60 via-slate-900/40 to-orange-950/60" />
        <div className="absolute inset-0 bg-black/20" />
        
        {/* Glowing aura blobs */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-20 -right-20 h-64 w-64 rounded-full bg-amber-400/25 blur-3xl mix-blend-screen" />
          <div className="absolute -bottom-20 -left-20 h-64 w-64 rounded-full bg-orange-500/25 blur-3xl mix-blend-screen" />
        </div>
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 flex flex-col items-center text-center">
          ...
          <p className="text-amber-100 text-xl max-w-2xl font-medium drop-shadow-[0_2px_8px_rgba(0,0,0,0.85)]">
