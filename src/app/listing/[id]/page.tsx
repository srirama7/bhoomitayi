                      ...
                      {profile.phone && (
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <a href={`tel:${profile.phone}`} className="text-sm font-semibold text-foreground hover:text-blue-600 dark:hover:text-blue-400 transition-colors">{profile.phone}</a>
                          </div>
                        </div>
                      )}
                      ...
                      {profile.phone && (
                        <>
                          ...
                          <Button 
                            ...
                            onClick={() => profile.phone && window.open(`https://wa.me/${profile.phone.replace(/\D/g, '')}`, '_blank')}
                          >
