...
const KNOWLEDGE_RESPONSES: Record<string, string> = {
  ...
  _list_guide: "COMPLETE LISTING GUIDE - Quick & simple, just 3 steps!\n\nStep 1: Choose Category\n- Click 'Register Service' in the navbar or menu\n- Select your category: House, Land, PG, Commercial, Vehicle, or Commodity\n- Choose your action: Sell, Rent, or Lease\n\nStep 2: Fill Basic Details\n- Title: Short & clear (e.g., 'Spacious 3BHK in Koramangala')\n- Description: Describe features, condition, nearby landmarks\n- Address: Your location / area\n- Phone Number: Buyers will call this number\n- Email: For inquiries\n- Photos: Upload 1–4 high-quality photos\n\nStep 3: Review & Submit\n- Check all details in the preview\n- Submit — listing goes live after admin approval!",
  ...
  _sell: "How to sell on BhoomiTayi — it's now super simple!\n\n1. Click 'Register Service' in the navbar\n2. Choose your category (House/Land/PG/Commercial/Vehicle/Commodity)\n3. Fill in: Title, Description, Address, Phone, Email\n4. Upload 1–4 photos\n5. Review the preview and Submit!\n\nThat's it — no lengthy forms, just the essentials. Buyers will contact you directly via your phone or email.",
